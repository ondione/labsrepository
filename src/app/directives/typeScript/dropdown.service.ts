...
export class DropdownService {
 ...
 constructor() {}
  ...
  public open(dropdownScope: DropdownDirective):void {
    if (!this.openScope) {
      document.addEventListener('click', this.closeDropdownBind, true);
      document.addEventListener('keydown', this.keybindFilterBind);
    }
  ...
  public close(dropdownScope: DropdownDirective):void {
    ...
    document.removeEventListener('click', this.closeDropdownBind, true);
    document.removeEventListener('keydown', this.keybindFilterBind);
  }
